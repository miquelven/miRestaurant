    ...
    >
      ...
      <Container>
        <div className="relative z-20 flex flex-col justify-center items-center gap-10 max-md:gap-16">
          <h1 className="text-8xl font-bold  text-center [text-shadow:_1px_3px_0_rgb(0_0_0_/_100%)] max-lg:text-7xl max-sm:text-5xl">
            Descubra Sabores Inesquecíveis!
          </h1>
          <h2 className="font-medium text-center text-2xl [text-shadow:_1px_2px_0_rgb(0_0_0_/_100%)] max-lg:text-xl max-sm:text-lg">
